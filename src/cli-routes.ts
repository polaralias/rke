...
export const CLI_ROUTES:Record<string,CliRoute>={
  ...
  "handoff write":{operation:"repo_handoff_write"},"handoff inspect":{operation:"repo_handoff_inspect"},"coordination validate":{operation:"repo_coordination_validate"},"coordination plan":{operation:"repo_coordination_plan"},
  ...
  "documentation bootstrap":{operation:"repo_documentation_bootstrap"},"documentation assess":{operation:"repo_documentation_assess"},"documentation apply":{operation:"repo_documentation_apply"},
