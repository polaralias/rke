...
export const CLI_ROUTES:Record<string,CliRoute>={
  ...
  "closure assess":{operation:"workflow_closure_assess"},"closure complete-small":{operation:"workflow_complete_small_change"},"legacy route":{operation:"workflow_legacy_route",positionals:["name"]},
